...
export default async function handler(req, res) {
  ...
  try {
    ...
    // We now check for the entire page's bounding box, which is much more reliable
    // ==========================================================
    if (detection && detection.pages[0] && detection.pages[0].boundingBox && detection.pages[0].boundingBox.vertices) {
